...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HrApi.PostionResponse();
  });
  ...
  describe('PostionResponse', function() {
    it('should create an instance of PostionResponse', function() {
      // uncomment below and update the code to test PostionResponse
      //var instance = new HrApi.PostionResponse();
      //expect(instance).to.be.a(HrApi.PostionResponse);
    });
